...
<head>
<title>Greenville Marine - Fountain, Sea Pro, Sea Ray, May-Craft, & Triton Boat Dealer - New and Used Fountain Powerboats</title>
  ...
  <tr>
    ...
    <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber2" background="images/gmtopback.jpg">
      <tr>
        ...
        <img border="0" src="images/gmtopleft.jpg" width="420" height="100"></a></td>
        <td width="37%" valign="top">
        <p align="right">
        <img border="0" src="images/gmtopright.jpg" width="124" height="22"></td>
      </tr>
    </table>
    </td>
  </tr>
...
<!--webbot bot="Include" i-checksum="31334" endspan -->&nbsp;</td>
        <td valign="top">
        <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="97%" id="AutoNumber5">
          <tr>
            <td width="100%"><img border="0" src="images/space.gif" width="8" height="8"></td>
          </tr>
          <tr>
            <td width="100%" background="images/headerback.gif">
            <img border="0" src="images/headercontact.gif" width="333" height="25"></td>
          </tr>
          <tr>
            <td width="100%"><img border="0" src="images/space.gif" width="8" height="8"></td>
          </tr>
          <tr>
            ...
            <div align="center">
              <center>
              <table id="AutoNumber9" style="border-collapse: collapse" borderColor="#111111" cellSpacing="5" cellPadding="5" width="80%" border="0">
                <tr>
                  <td width="39%" bgColor="#dfdfdf"><b><i>
                  <font face="Verdana" size="2">Address:</font></i></b></td>
                  <td align="right" width="61%" bgColor="#dfdfdf">
                  <span lang="en-us"><b><i><font face="Verdana" size="2">
                  Greenville Marine &amp; Sport Center<br>
                  3600 Greenville Blvd. NE<br>
                  Greenville, NC 27834</font></i></b></span></td>
                </tr>
                <tr>
                ...
                <tr>
                  <td width="39%" bgColor="#dfdfdf"><b><i>
                  <font face="Verdana" size="2">Phone:</font></i></b></td>
                  <td align="right" width="61%" bgColor="#dfdfdf"><b><i>
                  <font face="Verdana" size="2">Phone </font></i></b>
                  <span lang="en-us"><b><i><font face="Verdana" size="2">
                  252-758-5938</font></i></b></span></td>
                </tr>
                <tr>
                  <td width="39%" bgColor="#dfdfdf"><b><i>
                  <font face="Verdana" size="2">Fax Line:</font></i></b></td>
                  <td align="right" width="61%" bgColor="#dfdfdf"><b><i>
                  <font face="Verdana" size="2">Fax <span lang="en-us">
                  252-758-4783</span></font></i></b></td>
                </tr>
                <tr>
                  <td width="39%"><b><i>
                  </td>
                ...
                <tr>
                  <td width="39%" bgColor="#dfdfdf"><b><i>
                  <font face="Verdana" size="2">Email:</font></i></b></td>
                  <td align="right" width="61%" bgColor="#dfdfdf">
                  <i><b><a href="mailto:info@greenvillemarine.com">
					<span lang="en-us"><font size="2" face="Verdana">info</font></span><font face="Verdana" size="2">@<span lang="en-us">greenvillemarine.com</span></font></a></b></i></td>
                </tr>
                <tr>
                  <td width="39%" bgColor="#dfdfdf"><b><i>
                  <font face="Verdana" size="2">Website:</font></i></b></td>
                  <td align="right" width="61%" bgColor="#dfdfdf">
                  <span lang="en-us"><b><i><font face="Verdana" size="2">
                  <a href="http://www.greenvillemarine.com/">
                  www.greenvillemarine.com</a></font></i></b></span></td>
                </tr>
                </table>
              </center>
            </div>
            <p>&nbsp;</p>
            <form method="POST" action="email.asp?send=1" name="MyForm" onsubmit="return validate()">
             
            <table border="0" cellpadding="3" style="border-collapse: collapse" width="100%" id="table1">
              <tr>
                <td width="205">
                <p align="right"><span lang="en-us">
                <font size="2" face="Verdana">Name:</font></span></td>
                <td><input type="text" name="Name" size="20"></td>
              </tr>
              <tr>
                <td width="205">
                <p align="right"><span lang="en-us">
                <font size="2" face="Verdana">Address:</font></span></td>
              ...
              <tr>
                <td width="205">
                <p align="right"><span lang="en-us">
                <font size="2" face="Verdana">Phone:</font></span></td>
                <td><input type="text" name="Phone" size="20"></td>
              </tr>
              <tr>
                <td width="205" valign="top">
                <p align="right"><span lang="en-us">
                <font size="2" face="Verdana">Comments:</font></span></td>
              
                <td><textarea rows="5" name="Comments" cols="40"></textarea><p>
          ...
          <tr>
            ...
            <img border="0" src="images/footerb1.gif" width="333" height="13"></td>
          </tr>
          <tr>
            <td width="100%">
  ...
  <tr>
    ...
    <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber3" background="images/gmbotback.jpg">
      <tr>
        ...
        <img border="0" src="images/gmbotleft6.jpg" width="250" height="70"></td>
        <td width="56%" valign="top">
        <p align="right">
        <map name="FPMap0">
        <area href="http://www.greenvillemarine.com/" shape="rect" coords="7, 33, 254, 65">
        </map>
        <img border="0" src="images/gmbotright2.jpg" usemap="#FPMap0" width="255" height="70"></td>
      </tr>
    </table>
    </td>
  </tr>
