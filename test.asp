...
<!--webbot bot="Include" endspan i-checksum="31334" -->&nbsp;</td>
        <td valign="top">
        <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="97%" id="AutoNumber5">
          ...
          <tr>
            ...
            <img border="0" src="images/headerwelcome1.gif" width="333" height="25"></td>
          </tr>
          <tr>
            <td width="100%"><img border="0" src="images/space.gif" width="8" height="8"></td>
          </tr>
          <tr>
		    <td><!--#include file="incnews.asp"--></td></tr>
...
<!--webbot bot="Include" endspan i-checksum="22608" --></td>
          </tr>
        </table>
        </td>
      </tr>
